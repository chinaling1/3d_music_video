...
**无需编译，直接运行！** 项目中已经包含编译好的可执行文件：

| 版本 | 路径 | 大小 | 说明 |
|------|------|------|------|
| **Release** | `build\bin\Release\v3d_studio.exe` | 86 KB | 推荐使用，优化后的版本 |
| **Debug** | `build\bin\Debug\v3d_studio.exe` | - | 包含调试信息 |

直接双击 `build\bin\Release\v3d_studio.exe` 即可启动程序！
